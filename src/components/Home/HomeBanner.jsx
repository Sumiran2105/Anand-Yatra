    ...
    <section className="relative h-[280px] xs:h-[320px] sm:h-[400px] md:h-[480px] lg:h-[550px] rounded-2xl md:rounded-3xl overflow-hidden shadow-xl -mt-3 mx-4 sm:mx-6">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center h-full text-center px-4 sm:px-5 pt-8 sm:pt-12 md:pt-16 lg:pt-20">
        <motion.h1
          ...
          className="text-2xl xs:text-3xl sm:text-4xl md:text-5xl font-bold bg-gradient-to-r from-blue-400 to-yellow-400 sm:from-blue-500 sm:to-yellow-500 bg-clip-text text-transparent drop-shadow leading-tight"
        >
        ...
        >
          Unique experiences, breathtaking destinations, curated itineraries,
          and packages specially for you.
        </motion.p>
        ...
        <Link to="/trips" className="mt-4 sm:mt-6">
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            className="px-5 py-2.5 sm:px-7 sm:py-3 md:px-9 md:py-3.5 bg-yellow-500 hover:bg-yellow-400 text-black font-semibold rounded-full shadow-lg text-sm sm:text-base transition-colors"
          >
            Explore Trips
          </motion.button>
        </Link>
